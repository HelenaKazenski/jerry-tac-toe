...
**GUI Responsiveness**
Synchronizing user input with visual updates was challenging in an event-driven environment. Swing event listeners were used to 
handle user actions and immediately update the interface, ensuring the GUI accurately reflected the current game state without 
lag or inconsistencies.
